...
RSpec.describe "behavior_modification_levels/new", :type => :view do
  before(:each) do
    assign(:behavior_modification_level, BehaviorModificationLevel.new(
      :user_id => 1,
      :green => 1,
      :low_gi => 1,
      :oil => 1,
  ...
  it "renders new behavior_modification_level form" do
    render

    assert_select "form[action=?][method=?]", behavior_modification_levels_path, "post" do
